...
export const PAYMENT_FOLLOWUP_QUEUE = JOB_QUEUES.PAYMENT_FOLLOWUP;

export const PAYMENT_FOLLOWUP_JOB_NAMES = {
    ASSIGN_STORE_AND_DISPATCH: JOB_QUEUES.ASSIGN_STORE_AND_DISPATCH,
    DISPATCH_RETURN_DRIVER: JOB_QUEUES.DISPATCH_RETURN_DRIVER,
}
...
export const PAYMENT_TIMEOUT_SECONDS = 10;
...
export const BOOKING_TRANSITIONS = Object.freeze({
    [BOOKING_STATUS.CREATED]: [BOOKING_STATUS.PAYMENT_PENDING, BOOKING_STATUS.CANCELLED],
    [BOOKING_STATUS.PAYMENT_PENDING]: [BOOKING_STATUS.STORE_ASSIGNED, BOOKING_STATUS.CANCELLED],
    ...
    [BOOKING_STATUS.STORED]: [BOOKING_STATUS.RETURN_REQUESTED, BOOKING_STATUS.FINAL_PAYMENT_PENDING],
    [BOOKING_STATUS.RETURN_REQUESTED]: [BOOKING_STATUS.RETURN_DRIVER_ASSIGNED, BOOKING_STATUS.STORED, BOOKING_STATUS.FINAL_PAYMENT_PENDING],
    [BOOKING_STATUS.FINAL_PAYMENT_PENDING]: [BOOKING_STATUS.FINAL_PAYMENT_CAPTURED, BOOKING_STATUS.CANCELLED],
    [BOOKING_STATUS.FINAL_PAYMENT_CAPTURED]: [BOOKING_STATUS.RETURN_DRIVER_ASSIGNED, BOOKING_STATUS.STORED],
...
export const BOOKING_JOB_NAMES = {
    ...
    REVERT_IF_NO_DRIVER: "REVERT_IF_NO_DRIVER",
};