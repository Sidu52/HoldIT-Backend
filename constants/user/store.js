...
export const STORE_SELECT = {
    LIST: "store_name store_address store_open_time store_close_time store_description store_contact_number location rating rating_count is_online",
    DETAIL: "store_name store_address store_open_time store_close_time store_description store_contact_number location rating rating_count is_online booking_assigned_count max_booking_capacity service_area_id",
    AVAILABILITY: "store_name booking_assigned_count max_booking_capacity is_online is_active store_open_time store_close_time",
};
