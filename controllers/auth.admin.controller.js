...
export const getUserProfile = async (req, res) => {
    try {
        ...
        sendResponse({ res, message: "User profile fetched successfully", data: user });
    } catch (err) {
        console.error("Get User Profile Error:", err);
        sendResponse({ res, message: "Get User Profile failed", statusCode: STATUS_CODES.INTERNAL_SERVER_ERROR });
    }
};
